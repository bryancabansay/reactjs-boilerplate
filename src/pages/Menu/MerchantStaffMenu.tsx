            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Drawer variant="permanent"
                    ...
                    <List component="nav" sx={{ p: 1 }}>
                        ...
                        <ListItemButton component={Link} to='cashInMerchantStaff'>
                            <ListItemIcon>
                        ...
                        <ListItemButton component={Link} to='cashOutMerchantStaff'>
                            <ListItemIcon>
...
export default MerchantStaffMenu;